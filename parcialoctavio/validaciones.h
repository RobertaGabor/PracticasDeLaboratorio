...
/** \brief pide un caracter f o m y lo devuelve
 *
 * \param puntero char que guarda el caracter
 * \param mensaje que pide el sexo
 * \param mensaje que avisa si ingreso mal
 * \param cantidad de reintentos
 * \return devuelve 1 si se pudo guardar el char sino 0
 *
 */
int getSexo(char sexo[],char* mensaje,char* mensajeError,int reintentos);

/** \brief valida que sea un solo caracter y que sea f o m
 *
 * \param puntero que devuelve el caracter
 * \return devuelve 1 si se puso sino 0
 *
 */

int validatedSexo (char* sexo);
/** \brief valida que un caracter sea f o m
 *
 * \param puntero que devuelve el caracter
 * \return devuelve 1 si se pudo sino 0
 *
 */
